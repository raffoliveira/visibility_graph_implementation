...
def convert_beats_in_graphs(signals_II: dict) -> str:
    ...
    print(f'Mean conversion beats time: {np.array(beats_time).mean()} s')
...
if __name__ == '__main__':
    ...
    #segmentação
    print("segmentando...")
    train_signals_V1, train_signals_II = segmentation_signals(PATH, FILES_TRAIN, 100, 200, 'Train')
    val_signals_V1, val_signals_II = segmentation_signals(PATH, FILES_VAL, 100, 200, 'Train')
