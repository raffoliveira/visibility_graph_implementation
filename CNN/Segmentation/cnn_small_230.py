...
def plot_history_metrics(history: keras.callbacks.History):
    ...
    for key, value in history.history.items():
        ...
        plt.title(str(key))
        plt.savefig(f'C:\\Users\\rafae\\Documents\\Master\\Project\\Codes\\GNN_VG\\Scripts\\New_analyses\\Segmentation\\images\\{str(key)}.png', 
                    dpi=600)
...
def training(X_train, y_train, X_val, y_val, classes_weight):
    ...
    sns.heatmap(confusion_matrix(y_true, prediction), 
                ...
                fmt=".0f",
                cmap="rocket_r")    
    plt.savefig(f"C:\\Users\\rafae\\Documents\\Master\\Project\\Codes\\GNN_VG\\Scripts\\New_analyses\\Segmentation\\images\\confusion_matrix_cnn_small.png", dpi=600)

    with open("C:\\Users\\rafae\\Documents\\Master\\Project\\Codes\\GNN_VG\\Scripts\\New_analyses\\Segmentation\\images\\report_cnn_small.txt", "w") as f:
        f.write(classification_report(y_true, prediction, zero_division=0))

    with open('C:\\Users\\rafae\\Documents\\Master\\Project\\Codes\\GNN_VG\\Scripts\\New_analyses\\Segmentation\\images\\cnn_small.txt', 'w') as f:
        f.write('TRAIN\n')
