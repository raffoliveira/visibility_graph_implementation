...
def plot_history_metrics(history: keras.callbacks.History):
    ...
    for key, value in history.history.items():
        ...
        plt.title(str(key))
        plt.savefig(f'C:\\Users\\rafae\\Documents\\Master\\Project\\Codes\\GNN_VG\\Scripts\\New_analyses\\Intrapatient\\images\\{str(key)}.png', 
                    dpi=600)
...
def training(X_train, y_train, X_test, y_test, classes_weight):
    ...
    sns.heatmap(confusion_matrix(y_true, prediction), 
                ...
                fmt=".0f",
                cmap="rocket_r")    
    plt.savefig(f"C:\\Users\\rafae\\Documents\\Master\\Project\\Codes\\GNN_VG\\Scripts\\New_analyses\\Intrapatient\\images\\confusion_matrix_cnn_small.png", dpi=600)

    with open("C:\\Users\\rafae\\Documents\\Master\\Project\\Codes\\GNN_VG\\Scripts\\New_analyses\\Intrapatient\\images\\report_cnn_small.txt", "w") as f:
        f.write(classification_report(y_true, prediction, zero_division=0))

    with open('C:\\Users\\rafae\\Documents\\Master\\Project\\Codes\\GNN_VG\\Scripts\\New_analyses\\Intrapatient\\images\\cnn_small.txt', 'w') as f:
        f.write('TRAIN\n')
...
if __name__ == '__main__':
    ...
    test_signals_II = segmentation_signals(PATH,FILES_TEST,100,180,'Test')
